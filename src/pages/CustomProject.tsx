    ...
    <div className="min-h-screen bg-[#1A1A1A] pt-24">
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h1 className="text-4xl font-light mb-6">Projeto Personalizado</h1>
            <div className="space-y-6">
              <div>
                <h2 className="text-xl text-gold mb-3">Detalhes do Projeto</h2>
                <ul className="space-y-2 text-ice/80">
                  <li>• Até 25 unidades</li>
                  <li>• Até 4 pavimentos</li>
                  <li>• Projeto adaptável ao seu terreno</li>
                  <li>• Área útil personalizada por unidade</li>
                </ul>
              </div>
              ...
              <div className="bg-black/40 p-6 rounded-lg">
                ...
                <p className="text-3xl text-gold mb-2">R$ 1.000,00</p>
